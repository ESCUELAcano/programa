...
void registrar_profesor(string Nombre, string ApellidoP, string ApellidoM, string RFC, string FechaNacimiento, string Genero, string CedulaProfesional, string Telefono, string Experiencia) {
	/*Nombre: REGISTRAR_PROFESOR
	FLUJOS DE ENTRADA:
	Flujo 01: generales_profesor
	Composición: nombre+ApellidoP+ApellidoM+RFC+Fechanacimiento+Edad+Genero+Cedulaprofesional+Télefono+Experiencia
	Flujo de salida:
	VARIABLES*/
	MYSQL* coneccion;
	ifstream archivoSQL{ "SCRIPTS/llamarProcesoRegistrarProfesor.sql" };
